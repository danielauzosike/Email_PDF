...
def main(argv):
    ...
    report('/tmp/cars.pdf', "sales summary for last month", SUMMARY, cars_dict_to_table(data))
    # TODO: send the PDF report as an email attachment
    msg = email_generate("automation@example.com", "student-02-1fd13a93c123@example.com",
                         "Sales summary for last month", SUMMARY, "/tmp/cars.pdf")
    email_send(msg)
